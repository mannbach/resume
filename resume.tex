...
% \begin{center}
  \begin{tabular}{ll}
    ...
    \emph{Programming} &Python, SQL, Docker, Data Analysis \& Visualization, CI/CD\\
...
\begin{longtable}[l]{@{}p{.15\textwidth} p{0.85\textwidth}}
  04.2026     & Talk at In\_equality Conference, Konstanz, Germany on~\cite{bachmann.etal_networkinequalitypreferential_2026}\\
...
\pdfbookmark[2]{Professional Experience}{exp_prof}
