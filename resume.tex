...
% \begin{center}
  \begin{tabular}{@{}lp{0.80\textwidth}@{}}
    \emph{Research Interests} & Computational Social Science, Network Inequality, Complex Systems\\
    \emph{Programming} & Python, SQL, Docker, Network Analysis, Web Development\\
    \emph{Open-Source} & NetIn (\href{https://pypi.org/project/netin/}{\faPython}\,/\,\href{https://github.com/CSHVienna/NetworkInequalities}{\faGithub}\,/\,\href{https://cshvienna.github.io/NetworkInequalities/}{\faFile*[regular]}) Python package for analysing network inequalities\\
...
\pdfbookmark[1]{Education \& Research}{}
\section*{Education \& Research}
\label{academia}
\input{education.tex}
\pdfbookmark[1]{Education \& Research}{academia}
...
\begin{longtable}[l]{@{}p{.15\textwidth} p{0.85\textwidth}}
  07.2025     & Poster at International Conference on Computational Social Science (IC$^2$S$^2$)\\
              & in Norrk\"oping, Sweden on~\cite{bachmann.etal_networkinequalitypreferential_2026}\\
  08.2024     & Visualizing Complexity Science Workshop; Vienna, Austria\\
  03.2024     & Talk at DPG Spring Convention, Berlin, Germany on~\cite{bachmann.etal_cumulativeadvantagebrokerage_2026}\\
  09.2023     & Talk at Symposium on Scientific Elites, Copenhagen, Denmark on~\cite{bachmann.etal_cumulativeadvantagebrokerage_2026}\\
  07.2023     & Talk at International Conference on Computational Social Science (IC$^2$S$^2$)\\
              & in Copenhagen, Denmark on~\cite{bachmann.etal_cumulativeadvantagebrokerage_2026}\\
  10.2022     & Talk at Conference on Complex Systems (CCS), Palma de Mallorca, Spain on~\cite{bachmann.etal_cumulativeadvantagebrokerage_2026}
\end{longtable}
