...
% \begin{center}
  \begin{tabular}{ll}
    ...
    \emph{Open-source} &\textbf{NetIn}~(\href{https://pypi.org/project/netin/}{\faPython}~\href{https://github.com/CSHVienna/NetworkInequalities}{\faGithub}): Python package for the analysis of network inequalities\\
