...
% \begin{center}
  \begin{tabular}{ll}
    \emph{Forschung} & Science of Science, Computational Social Science, Komplexe Systeme\\
    \emph{Programmierung} & Python, SQL, Docker, Datenanalyse \& Visualisierung, CI/CD\\
...
\begin{itemize}
    \item \textbf{NetIn} (~\href{https://pypi.org/project/netin/}{\faPython}
        ...
        : Python-Paket zur Analyse von Ungleichheiten in Netzwerken.
