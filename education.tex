...
\begin{longtable}[l]{@{}p{.15\textwidth} p{0.85\textwidth}}
    ...
    \begin{itemize}
        \item \raggedright How local link-formation in social networks generates systemic inequalities in visibility and reach (supervised by \href{https://csh.ac.at/fariba-karimi/}{Fariba Karimi})
    \end{itemize}\\
